...
/// @title MerkleTreeCHRNFT
/// @notice ERC20 claimable by members of a merkle tree
/// @author Anish Agnihotri <contact@anishagnihotri.com>
/// @dev Solmate ERC20 includes unused _burn logic that can be removed to optimize deployment cost

/*
    Based off Solmate [thanks]. Merkle contract to claim Chronos Airdrop.
*/

contract MerkleTreeCHRNFT {
    ...
    constructor(address _airdropClaim) {
        airdropClaim = _airdropClaim; // CHR NFT AIRDROP CLAIM CONTRACT
        owner = msg.sender;
    }
