...
contract ChronosGovernor is L2Governor, L2GovernorCountingSimple, L2GovernorVotes,  L2GovernorVotesQuorumFraction {
    address public team;
    ...
    // _quorum = 10 -> 10%
    constructor(IVotes _ve, uint _quorum) L2Governor("Chronos Governor") L2GovernorVotes(_ve) L2GovernorVotesQuorumFraction(_quorum) {
        team = msg.sender;
    }
